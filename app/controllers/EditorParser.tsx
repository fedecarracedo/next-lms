...
export default function parseEditorElement(blockElement: any): JSX.Element | undefined {
    let elemTag: string
    ...
    switch (blockElement.type) {
        case "header":
            ...
            elemProps = {className: 'block font-sans text-'+(6-blockElement.data.level)+'xl antialiased font-semibold leading-tight tracking-normal text-inherit mb-5 mt-5'}
            elemContent = blockElement.data.text
            break;
        case "paragraph":
            elemTag = 'p'
            elemProps = {className: 'block font-sans text-lg antialiased font-normal leading-relaxed text-inherit text-justify mb-4'}
            elemContent = blockElement.data.text
            break
        case "list":
