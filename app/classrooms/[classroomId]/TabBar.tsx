          ...
          return (
            <li>
              <a
                ...
                className={
                  selected == index
                    ? "inline-flex items-center px-4 py-3 rounded-lg text-white bg-gray-50 w-full dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white active"
              ...
              >
                <svg
                  ...
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill={selected == index ? "white" : "currentColor"}
                  viewBox="0 0 20 20"
                >
                  {elem.svg}
                </svg>
