...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-03-2024 a las 04:31:35
...
CREATE TABLE `aula` (
  ...
  `aula_inicio` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`aula_inicio`)),
...
INSERT INTO `aula` (`aula_id`, `aula_nombre`, `aula_descripcion`, `aula_organizacion`, `aula_inicio`, `aula_docentes`, `aula_faq`, `aula_curso`) VALUES
(3, 'Aula de prueba', 'asdasd', '', '{\"time\":1709597043458,\"blocks\":[{\"id\":\"o-IomhWhSs\",\"type\":\"header\",\"data\":{\"text\":\"Encabezado\",\"level\":2}},{\"id\":\"wtikiIfLL4\",\"type\":\"paragraph\",\"data\":{\"text\":\"Texto\"}}],\"version\":\"2.29.0\"}', '', '', 2),
(7, 'Marketing 360', 'Un curso para aquellos que desean aprender sobre Marketing.', '', '{\"time\":1709603665026,\"blocks\":[{\"id\":\"SrpUnITxcx\",\"type\":\"header\",\"data\":{\"text\":\"Sobre el curso\",\"level\":2}},{\"id\":\"MbdxMbcSTC\",\"type\":\"list\",\"data\":{\"style\":\"ordered\",\"items\":[\"Presta atencion\",\"Intenta anotar todo\",\"Esfuerzate\"]}},{\"id\":\"UHZHjdWTEU\",\"type\":\"embed\",\"data\":{\"service\":\"youtube\",\"source\":\"https://www.youtube.com/watch?v=aVo203YQoZM\",\"embed\":\"https://www.youtube.com/embed/aVo203YQoZM\",\"width\":580,\"height\":320,\"caption\":\"\"}}],\"version\":\"2.29.0\"}', '', '', 2);
...
CREATE TABLE `usuario_aula` (
  `usuario_aula_usuario` int(11) NOT NULL,
  `usuario_aula_aula` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `usuario_aula`
  ADD PRIMARY KEY (`usuario_aula_usuario`,`usuario_aula_aula`),
  ADD KEY `aula_id` (`usuario_aula_aula`);
...
--
ALTER TABLE `usuario_aula`
  ADD CONSTRAINT `usuario_aula_ibfk_1` FOREIGN KEY (`usuario_aula_aula`) REFERENCES `aula` (`aula_id`),
  ADD CONSTRAINT `usuario_aula_ibfk_2` FOREIGN KEY (`usuario_aula_usuario`) REFERENCES `usuario` (`usuario_id`);
